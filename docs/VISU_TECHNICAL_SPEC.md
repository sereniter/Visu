...
├── config/                  # shared.json + mode_a|b|c.json (layered); languages.json (Sprint 8); grades.json, visual_styles.json (Sprint 13). Legacy: default.json alone if shared.json absent.
